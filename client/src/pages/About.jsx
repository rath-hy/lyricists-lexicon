...
const content = {
  en: {
    ...
    body: [
      <>
        This is the website version of The Lyricist's Lexicon (nicknamed the "poet's dictionary"), a pair of books that catalogue rhymes and consonances in Khmer. Authored in 2024 by Rath Hy, the books can be downloaded <a href="https://drive.google.com/drive/folders/1XWe2odMrgn3ZwdIoZfhy2WHQG7_HgCDx?usp=sharing" target="_blank" rel="noreferrer">here</a>. If you'd like to learn more about the story of the books, please visit the <a href="https://puthyrathy.com" target="_blank" rel="noreferrer">author's personal website</a>.
      </>,
